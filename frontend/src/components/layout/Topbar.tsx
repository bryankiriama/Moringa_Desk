        ...
        <div className="flex min-w-[220px] flex-1 items-center">
          <div className="relative w-full max-w-2xl">
            ...
            <input
              ...
              className="w-full rounded-full border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-4 text-sm text-slate-700 shadow-sm focus:border-indigo-300 focus:outline-none focus:ring-2 focus:ring-indigo-100"
            />
          </div>
        </div>
